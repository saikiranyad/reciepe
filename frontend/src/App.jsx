...
// //     } else {
// //       // If no user in localStorage, verify with the backend
// //       const checkauth = async () => {
// //         try {
// //           const response = await axios.get(`${USER_BACKEND_URL}/getuser`, {
// //             withCredentials: true,
// //           });
// //           if (response.data && response.data.havinguser) {
...
// //          <Route
// //           path="/addreciepe"
// //           element={user ? <AddReciepe /> : <Login />}
// //         />
// //         <Route path="/card" element={user ?<Myreciepes/>: <Login />}/>
// //         <Route path="/reciepe/:id" element={user ?<Veiwreciepe/>: <Navigate to='/login'}/>/>
// //         <Route path="/updaterecipe/:id" element={user ?<Updaterecipe/>: <Login />}/>
// //         <Route path = '/saved' element = {user ?<Savedreciepe/>: <Login />}/>
